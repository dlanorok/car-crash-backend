...
class Country(Place):
    def to_presentation(self):
        if self.marker_position.lng:
            geolocator = Nominatim(user_agent="car_crash_assist")
            return geolocator.reverse(f"{self.marker_position.lat}, {self.marker_position.lng}").raw.get("address").get(
                "country")
        else:
            return self.written_position
...
def get_questionnaire(is_organizer):
    questionnaire = {
        "car_arrow": "",
        "sections": [
            {
            ...
            },
            {
                ...
                "state": "empty",
                "starting_step": Step.CIRCUMSTANCES_INITIAL_PAGE if is_organizer else Step.TERMS_OF_SERVICE_STEP_INITIAL_PAGE
            },
            {
                "id": "vehicle_damage",
        ...
        "steps": [
            ...
            },
            {
                ...
                "next_step": Step.TERMS_OF_SERVICE_STEP_INITIAL_PAGE,
                "inputs": [],
            },
            {
                **TOS_PAGE(is_organizer)
            },
            {
            ...
            },
            {
                ...
                "question": str(
                    _('For data exchange purposes and contact with your insurance company we need your email and telephone number.')),
        ...
        "inputs": {
            ...
            **moving_questionnaire.inputs,
            **roundabout_questionnaire.inputs,
            **crossing_questionnaire.inputs,
            **driving_straight_questionnaire.inputs
        }
    }
...
QUESTIONNAIRE_MAP = generate_circumstance_map(get_questionnaire(True))
