...
QUESTIONNAIRE = {
  ...
  "steps": [
    ...
    },
    {
      ...
      "help_text": str(_('help text cirucmstances inital page')),
    ...
    },
    {
      ...
      "main_screen": True,
      "chapter": True,
      "question": str(_('ZAČNIMO VEHICLE DAMAGES INITIAL PAGE')),
      "help_text": str(_('help text vehicle damage inital page')),
    ...
    },
    {
      ...
      "main_screen": True,
      "chapter": True,
      "question": str(_('ZAČNIMO ACCIDENT SKETCH INITIAL PAGE')),
      "help_text": str(_('help text sketch inital page')),
    ...
    },
    {
      ...
      "main_screen": True,
      "chapter": True,
      "question": str(_('ZAČNIMO CAR AND INSURANCE INITIAL_PAGE')),
      "help_text": str(_('help text car adn insurance inital page')),
    ...
    },
    {
      ...
      "help_text": str(_('help text driver and personal data inital page')),
    ...
    },
    {
      ...
      "main_screen": True,
      "chapter": True,
      "question": str(_('ZAČNIMO ADDITIONAL INITIAL PAGE')),
      "help_text": str(_('help text additional inital page')),
    ...
    },
    {
      ...
      "main_screen": True,
      "chapter": True,
      "question": str(_('ZAČNIMO CONFIRMATION STEP INITIAL_PAGE')),
      "help_text": str(_('help text confirmation section inital page')),
